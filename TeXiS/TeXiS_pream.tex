...
%%Para ver el layout (margenes y espacios)
...
\ifx\generaacronimos\undefined
  % No queremos acrónimos. Como no incluiremos el paquete glossaries
...
% Define el entorno  multirow que sirve para crear celdas que ocupan mas de 1
% fila en una tabla
...
%Margenes de 2.5 a cada lado (el de arriba 2 + 0.5)
\usepackage[verbose]{geometry}
\geometry{a4paper}
%\geometry{twosideshift=0pt}
\geometry{top=2.0cm,bottom=2.5cm,left=2.5cm,right=2.5cm,headsep=0.5cm}
...
% Para poder usar toprule/mid/bottomrule en las tablas
\usepackage{booktabs}
%Para poder posicionar los elementos en una posicion fija [H]
\usepackage{float}
%Para poder definir nuevos tipos de columnas en las tablas entre otros
\usepackage{array}
%Para rotar las tablas usando sidewaystable y que siempre vayan en el mismo sentido
\usepackage[figuresleft]{rotating}
%Para rotar las tablas usando landscape
%\usepackage{pdflscape}
%Para usar el comando LXTable que incustra tablas externas
%\usepackage{ltxtable}
%Para el simbolo del euro
\usepackage{eurosym}
%Para que coja uniformemente los espacios y no deje espacios en blancos grandes
\raggedbottom

%Para incluir las portadas enteras desde pdf
\usepackage{pdfpages}


%Un comando que se aplica a todo una fila de la tabla 
