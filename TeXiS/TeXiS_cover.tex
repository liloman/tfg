...
\def\imagenPortadaVal{Imagenes/Vectorial/Portada}
...
\def\tipoDocumentoVal{Trabajo Fin de Grado}
...
% Portada
%%%
%Se incluyen los pdf generados de los ppt con la portada y el resumen
\includepdf[pages=-]{Imagenes/Vectorial/Portada}
\includepdf[pages=-]{Imagenes/Vectorial/Resumen}
